...
<AccordionGroup>
<Accordion title="Can I use the same account for several CBPay accounts?">
...
<Accordion title="Can I delete or rotate the account?">
...
<Accordion title="How quickly is a transfer credited?">
