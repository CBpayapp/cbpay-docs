...
<AccordionGroup>
<Accordion title="Do I need to create deposit wallets?">
...
<Accordion title="When is a deposit credited to my balance?">
...
<Accordion title="Why is my withdrawal asking for beneficiary data?">
...
<Accordion title="Can I withdraw GOLD on-chain?">
No — GOLD is a ledger-only balance without an on-chain rail. Convert it
with [Swaps](/en/guides/swaps) to a withdrawable asset first.
</Accordion>
<Accordion title="Why was my withdrawal blocked with compliance_hold?">
