...
<AccordionGroup>
<Accordion title="Does scanning a QR cost anything?">
No — the scan is a free local read. You are only charged when the confirm
creates the payout.
</Accordion>
<Accordion title="Can I pay the same QR twice?">
...
<Accordion title="How do I retry a failed confirm safely?">
