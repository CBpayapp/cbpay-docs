...
<Update label="26 de septiembre de 2026" description="v2.131 · 2 versiones">
...
<Update label="25 de septiembre de 2026" description="v2.129 · 1 versión">
...
<Update label="24 de septiembre de 2026" description="v2.128 · 4 versions">
...
<Update label="23 de septiembre de 2026" description="v2.124 · 3 versiones">
...
<Update label="22 de septiembre de 2026" description="v2.121 · 3 versions">
...
<Update label="21 de septiembre de 2026" description="v2.118 · 2 versiones">
...
<Update label="20 de septiembre de 2026" description="v2.116 · 1 versión">
...
<Update label="19 de septiembre de 2026" description="v2.115 · 6 versiones">
...
<Update label="18 de septiembre de 2026" description="v2.109 · 8 versiones">
...
<Update label="17 de septiembre de 2026" description="v2.101 · 8 versiones">
...
<Update label="16 de septiembre de 2026" description="v2.92 · 4 versiones">
...
<Update label="15 de septiembre de 2026" description="v2.88 · 3 versiones">
...
<Update label="14 de septiembre de 2026" description="v2.85 · 5 versiones">
...
<Update label="13 de septiembre de 2026" description="v2.80 · 3 versiones">
...
<Update label="12 de septiembre de 2026" description="v2.77 · 3 versions">
...
<Update label="11 de septiembre de 2026" description="v2.74 · 1 versión">
...
<Update label="10 de septiembre de 2026" description="v2.73 · 1 versión">
...
<Update label="9 de septiembre de 2026" description="v2.72 · 1 versión">
...
<Update label="6 de septiembre de 2026" description="v2.71 · 3 versiones">
...
- **Tu `idempotency_key` vuelve en los webhooks**. Los webhooks de cuenta
  ...
  [webhooks](/es/webhooks#tu-idempotency-key-vuelve-en-el-payload) e
  [idempotencia](/es/conceptos/idempotencia).

</Update>

<Update label="4 de septiembre de 2026" description="v2.68">
...
- **El cobro pull de Venezuela (`c2p` / `debito_inmediato`) ya no está
  ...
  [payins](/es/guias/payins) y [checkout](/es/guias/checkout).

</Update>

<Update label="3 de septiembre de 2026" description="v2.67 · 2 versiones">
...
- **Los payouts de Venezuela `pago_movil` ahora exigen `beneficiary.name`**.
  ...
  cédula) — un solo token es rechazado. La [guía de payouts](/es/guias/payouts)
...
<Update label="2 de septiembre de 2026" description="v2.65">
...
- **Webhooks `wallet_signature_created` y `wallet_linked`.** Se emiten al crear un proof y al vincular una wallet externa. Referencia: [Webhooks](/es/webhooks).
...
<Update label="12 de agosto de 2026" description="v2.60">
...
<Update label="11 de agosto de 2026" description="v2.59">
...
- **Payouts USD por rail bancario: el beneficiario puede vivir en cualquier
  país** ([guía de payouts](/es/guias/payouts)): en transferencias `ach`,
...
<Update label="10 de agosto de 2026" description="v2.58 · 3 versiones">
...
- **Los payins con tarjeta con liquidación diferida se confirman `credited`
  de inmediato**
  ([comisiones](/es/conceptos/comisiones#settlement-de-payins-con-tarjeta)):
...
- **Nuevo error `settlement_pending`** (`422`): devolver un cobro con
  ...
  org-admin). Detalle en [devoluciones](/es/guias/devoluciones).
...
<Update label="9 de agosto de 2026" description="v2.55 · 6 versiones">
...
- **Comisiones banking por riel**
  ([comisiones](/es/conceptos/comisiones#comisiones-banking-por-riel)):
...
- **Sello público verificable Qscore** ([guía del sello](/es/guias/qscore-seal)):
...
- **Links de consentimiento Qscore (autorización del titular)** ([guía de links de consentimiento](/es/guias/qscore-consents)):
...
- **Scoring Qscore por lote (portfolio scoring)** ([guía Scoring por lote](/es/guias/qscore-batch)):
...
<Update label="8 de agosto de 2026" description="v2.49 · 9 versiones">

### v2.49

**Agregado**

- **Qscore — tu propio informe crediticio, gratis** ([guía Qscore](/es/guias/qscore)):
...
- **Qscore — monitoreo continuo de sujetos** ([guía Qscore](/es/guias/qscore)):
  ...
  Nuevo código de error: `report_required` ([errores](/es/errores)).
...
- **Referencia bancaria del payout, ahora visible en todas las superficies**
  ([guía de payouts](/es/guias/payouts)): todo payout expone
...
- **Qscore — buró de crédito API-first** ([guía Qscore](/es/guias/qscore)):
...
- **Mejora de calidad del catálogo de ciudades** ([guía de catálogos AML](/es/guias/aml)):
...
- **Link de seguimiento desde la API** ([guía de seguimiento](/es/guias/seguimiento)): el nuevo
...
- **Link de seguimiento público para cada transacción**
  ([guía de seguimiento](/es/guias/seguimiento)): cada comprobante (payout, payin, refund,
...
<Update label="7 de agosto de 2026" description="v2.40 · 4 versiones">
...
- **Lookup del directorio bancario** ([guía de
  payouts](/es/guias/payouts)): el nuevo
  ...
  max-age=86400`.
- **Lookup por código postal** ([guía AML](/es/guias/aml)): el nuevo
...
- **Catálogo de ciudades por país** ([guía AML](/es/guias/aml)): el nuevo
...
- **Los payins US/USD ahora publican dos rieles de depósito** ([guía de
  payins](/es/guias/payins)): el corredor de transferencia anunciada
...
- **Rechazo automático por plazo de revisión** ([guía de revisiones](/es/guias/revisiones-operaciones)) —
...
- **Nuevo corredor de payin: Estados Unidos (USD) por transferencia
  ...
  [guía de Payins](/es/guias/payins); el bloque `deposit_instructions` y el
  endpoint de preview quedaron actualizados en la referencia de API.

</Update>

<Update label="6 de agosto de 2026" description="v2.36 · 3 versiones">
...
- **Firewall transaccional**: cuando tu organización tiene el firewall
  ...
  [Revisiones de operaciones](/es/guias/revisiones-operaciones).
...
- **Nuevo corredor de payouts: Estados Unidos (USD)** con tres métodos —
  ...
  ejemplos reales y FAQ en [Payouts](/es/guias/payouts); ejemplos
...
- La página [Servidor MCP](/es/mcp) ahora menciona el servidor MCP dedicado
...
<Update label="5 de agosto de 2026" description="v2.33 · 2 versiones">
...
- **Nuevo valor mágico `HOLDREVIEW` en el entorno de pruebas**: una
  ...
  [entorno de pruebas](/es/entorno-y-pruebas).

</Update>

<Update label="4 de agosto de 2026" description="v2.31 · 4 versiones">
...
- **Comisión por compra con tarjeta**: las transacciones de tarjeta ahora
  ...
  [tarjetas](/es/guias/tarjetas#comisión-por-compra-ciclo-de-vida).
...
<Update label="3 de agosto de 2026" description="v2.27 · 2 versiones">
...
- **Desactivar y reactivar suscripciones de webhook**: nuevo
  ...
  [guía de webhooks](/es/webhooks#desactivar-y-reactivar-una-suscripción).
...
<Update label="2 de agosto de 2026" description="v2.25 · 3 versiones">
...
- **Códigos de error de administración documentados**: se agregaron los
  ...
  [catálogo de errores](/es/errores). Provienen de superficies de
...
- **Instrucciones de depósito para transferencias anunciadas**
  ([guía de payins](/es/guias/payins)): crear un payin con
...
<Update label="1 de agosto de 2026" description="v2.22 · 1 versión">
...
- **La prueba de vida ahora admite varias sesiones por sujeto**
  ([verificación de identidad](/es/guias/kyc)): el array `liveness[]` del
...
<Update label="30 de julio de 2026" description="v2.21 · 1 versión">
...
- **Informe de verificación con portada navegable**
  ([verificación de identidad](/es/guias/kyc)): el PDF abre con un índice de
...
<Update label="28 de julio de 2026" description="v2.20 · 2 versiones">
...
- **Evidencia visual en el informe de verificación**
  ([verificación de identidad](/es/guias/kyc)): cuando el proveedor publica
...
- **Informe de verificación completo, sin datos descartados**
  ([verificación de identidad](/es/guias/kyc)): el informe KYC/KYB pasó de
...
<Update label="27 de julio de 2026" description="v2.18 · 3 versiones">

### v2.18

**Corregido**

- **Montos siempre en decimal plano** ([payins](/es/guias/payins)): el campo
...
- **Informe de verificación KYC/KYB descargable**
  ([verificación de identidad](/es/guias/kyc)): cada submission de KYC/KYB
...
- **Los cobros QR se acreditan siempre solos** ([payins](/es/guias/payins)):
...
<Update label="26 de julio de 2026" description="v2.15 · 1 versión">
...
- **Las transferencias anunciadas ya respetan la idempotencia**
  ([payins](/es/guias/payins)): `POST /v1/payins` con
...
<Update label="25 de julio de 2026" description="v2.14 · 6 versiones">
...
- **Las transferencias anunciadas ya no matchean "la más antigua" por monto**:
  ...
  [Cómo se concilia una transferencia anunciada](/es/guias/payins).

### v2.13

**Agregado**

- **Cuota del handshake del stream de eventos** ([errores](/es/errores)): abrir
...
- **Stream de eventos en tiempo real** ([guía](/es/eventos-tiempo-real)):
...
- **Tres eventos nuevos** ([webhooks](/es/webhooks)): `balance_adjusted` (un
  ...
  y por el stream.
- **Códigos de error nuevos** ([errores](/es/errores)): `too_many_streams`,
...
- **Devoluciones de cobros con tarjeta**
  ([guía](/es/guias/devoluciones)): `POST /v1/payins/{payinID}/refunds`
...
- **Webhook `payin_refunded`** ([webhooks](/es/webhooks)): notifica cada
...
- **Códigos de error nuevos** ([errores](/es/errores)):
...
- **Página pública de estado del servicio rediseñada**
  ([guía](/es/estado-del-servicio)): la página que entrega
...
- **Tarjetas internacionales en dólares** ([guía](/es/guias/payins)):
  ...
  [cobros posteriores y suscripciones](/es/guias/stored-cards-subscriptions).
...
<Update label="24 de julio de 2026" description="v2.08 · 6 versiones">

### v2.08

**Agregado**

- **Estado del servicio en tiempo real** ([guía](/es/estado-del-servicio)):
...
- **Docs Knowledge Pack para IA/MCP**: esta documentación ahora se publica
  ...
  oficial que alimenta el [servidor MCP](/es/mcp) de la documentación.
...
- **FAQ ancla en todas las guías de producto**: payouts, payins, checkout,
  ...
  link directo al [catálogo de errores](/es/errores).
...
- **Guías propias por producto**, extraídas de los monolitos de
  payins/payouts: [Checkout](/es/guias/checkout),
  [Tarjetas guardadas y suscripciones](/es/guias/stored-cards-subscriptions)
  y [Payout QR](/es/guias/qr-payout). Las secciones originales conservan sus
  encabezados y enlazan a las guías nuevas, así los anchors históricos
  siguen resolviendo.
- **Flujos end-to-end nuevos** en [Flujos de integración](/es/flujos):
...
- [Perfil y seguridad](/es/guias/perfil) y
  [Seguridad y 2FA (OTP)](/es/seguridad-2fa) ahora se cruzan y declaran sus
...
- **Ambiente de pruebas visible en todo el sitio**: cada guía de producto
  ...
  [FAQ](/es/faq), el [inicio rápido](/es/inicio-rapido) y la
  [introducción](/es/introduccion) describen correctamente el ambiente de
  ...
  completo en [Entorno y pruebas](/es/entorno-y-pruebas).
...
<Update label="23 de julio de 2026" description="v2.02 · 6 versiones">
...
- **La auto-conversión al `default_payin_asset` ejecuta al precio real,
  sin spread de swap** ([modelo de dinero](/es/conceptos/modelo-de-dinero)):
...
- **Código de error `reserved_idempotency_key` (400)** en `POST /v1/swaps`
  ([errores](/es/errores)): las claves de idempotencia con prefijo
...
- **Saldo predeterminado para payins (`default_payin_asset`)**
  ([modelo de dinero](/es/conceptos/modelo-de-dinero)): configura en qué
...
- **Comisión propia para cobros con tarjeta (`payin_card`)**
  ([comisiones](/es/conceptos/comisiones)): los cobros acreditados con
...
- **`GET /v1/banking/accounts/{bankAccountID}`** ([guía banking](/es/guias/banking)):
...
<Update label="22 de julio de 2026" description="v1.96 · 3 versiones">

### v1.96

**Agregado**

- **Nuevo corredor: Argentina** 🇦🇷 ([guía payouts](/es/guias/payouts) · [guía payins](/es/guias/payins)):
...
- **Página de checkout — pago con tarjeta en 1 clic** ([guía payins](/es/guias/checkout)): al continuar con tarjeta, la página pública ahora redirige directo a la página segura de pago — se eliminó el botón intermedio que exigía un segundo clic. Elegir una tarjeta guardada de la lista inicia el pago de inmediato.
...
<Update label="17 de julio de 2026" description="v1.87 · 4 versiones">
...
<Update label="16 de julio de 2026" description="v1.83 · 10 versiones">
...
- **Payout por QR PIX en Brasil (BR/BRL)**: el flujo de dos pasos
  ...
  **reutilizable**: cada pago lleva su propia `idempotency_key`. Los QR
  ...
  la [guía de payouts](/es/guias/qr-payout).
...
- **Link de cobro universal v2 — multi-país + liquidación en el saldo
  ...
  **auto-convierte** al `settlement_asset` al acreditar (mismo asset no
  ...
  [guía de payins](/es/guias/checkout).
...
<Update label="15 de julio de 2026" description="v1.73 · 5 versiones">
...
<Update label="14 de julio de 2026" description="v1.68 · 7 versiones">
...
<Update label="13 de julio de 2026" description="v1.61 · 6 versiones">
...
<Update label="12 de julio de 2026" description="v1.55 · 9 versiones">
...
<Update label="11 de julio de 2026" description="v1.46 · 7 versiones">
...
<Update label="10 de julio de 2026" description="v1.39 · 7 versiones">
...
<Update label="9 de julio de 2026" description="v1.32 · 7 versiones">
...
<Update label="8 de julio de 2026" description="v1.25 · 8 versiones">
...
<Update label="7 de julio de 2026" description="v1.17 · 16 versiones">
...
<Update label="6 de julio de 2026" description="v1.1 · 2 versiones">
