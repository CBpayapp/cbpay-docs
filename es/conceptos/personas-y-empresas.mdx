...
| **Wallets de depósito** ([crypto](/es/guias/crypto)) por red+activo | **1** (nacen con la cuenta; solo reciben) | **1** (nacen con la cuenta; solo reciben) |
| **Wallets segregadas** ([saldo propio on-chain](/es/guias/wallets-segregadas)) | **1 por red+activo** | **Ilimitadas** (usa `label` para distinguirlas) |
