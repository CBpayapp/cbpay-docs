...
([guía de webhooks](/es/webhooks)) y recibirás cada transición en el momento
...
<AccordionGroup>
  <Accordion title="¿Un corredor down rechaza mis requests?">
  ...
  <Accordion title="¿Qué tan rápido se detecta una caída?">
  ...
  <Accordion title="¿Necesito hacer polling a los catálogos para seguir la disponibilidad?">
  ...
  <Accordion title="¿Qué pasa con las operaciones en vuelo cuando un corredor cae?">
  ...
  <Accordion title="¿Puedo white-labelear la página de status?">
  ...
  <Accordion title="¿Por qué no aparece un corredor en la página de status?">
  ...
  <Accordion title="¿Por qué no veo qué proveedor está detrás de un incidente?">
