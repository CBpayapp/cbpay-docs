...
(cobra como un payout normal). Detalle: [payouts](/es/guias/payouts) ·
[payout QR](/es/guias/qr-payout).
...
Detalle: [payins](/es/guias/payins) · [checkout](/es/guias/checkout).
...
Detalle: [checkout](/es/guias/checkout).
...
Detalle: [tarjetas guardadas y suscripciones](/es/guias/stored-cards-subscriptions).
...
Detalle: [QR POS](/es/guias/qr-pos).
