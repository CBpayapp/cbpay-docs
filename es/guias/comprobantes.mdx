...
y la descarga del PDF. Ver [Link de seguimiento de transacciones](/es/guias/seguimiento).
...
<AccordionGroup>
  <Accordion title="¿El comprobante se genera una sola vez o puedo descargarlo cuando quiera?">
  ...
  <Accordion title="¿Puedo compartir el comprobante con el beneficiario o con un auditor?">
  ...
  <Accordion title="¿Qué pasa si alguien edita el PDF?">
  ...
  <Accordion title="¿En qué idiomas está el comprobante?">
  ...
  <Accordion title="¿Con qué marca sale el comprobante?">
...
<CardGroup cols={1}>
  <Card title="Link de seguimiento de transacciones" icon="location-arrow" href="/es/guias/seguimiento">
    Cada comprobante tiene además una página pública de seguimiento compartible con timeline del estado en vivo — sin iniciar sesión.
  </Card>
</CardGroup>
