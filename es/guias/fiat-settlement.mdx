...
Consulta [Errores](/es/errores) para el contrato público de errores.

<AccordionGroup>
<Accordion title="¿Puedo debitar BOB para un payout MXN?">
...
<Accordion title="¿Se aplican spreads al fiat de la misma moneda?">
