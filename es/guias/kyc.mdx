...
<Note>Las solicitudes nuevas exigen TOTP confirmado o passkey registrado; revisa [Perfil y seguridad](/es/guias/perfil) para enrolar uno y reintenta. Los links abiertos se re-sirven antes del gate; la automatización con API key sigue exenta.</Note>
<Steps>
...
<Accordion title="¿Por qué la verificación me pide contactar al administrador?">Un administrador pudo haber desactivado o cerrado la cuenta, o rechazado su KYC/KYB. En esos estados, `POST /v1/me/verification/link` no vuelve a servir ni crea un link self-service. Primero el administrador debe restaurar la cuenta o reabrir la verificación.</Accordion>
...
el [AML screening](/es/guias/aml) consulta listas de sanciones/PEP/prensa
...
<Accordion title="¿Recibo un email cuando aprueban o rechazan mi verificación?">
