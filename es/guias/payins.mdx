...
[el modelo de dinero](/es/conceptos/modelo-de-dinero#elige-en-que-saldo-se-acreditan-tus-payins).
...
[guía de cuentas virtuales BOB](/es/guias/bob-virtual-accounts). Una cuenta
...
- **Settlement diferido**: cuando la comisión de `payin_card` está
  ...
  [link de checkout](/es/guias/checkout) o un
  [cobro POS](/es/guias/qr-pos) se paga con tarjeta. Detalle en
...
<Tab title="SWIFT internacional (BIC)">
...
<Card title="Checkout" icon="cart-shopping" href="/es/guias/checkout" horizontal>
  Un solo link donde el pagador elige cómo pagar — fiat en todos los países
  activos, crypto, tarjeta o la app CBPay — liquidado en el saldo que elijas.
</Card>
...
<Card title="Tarjetas guardadas y suscripciones" icon="credit-card" href="/es/guias/stored-cards-subscriptions" horizontal>
  Guarda tarjetas con consentimiento del pagador, cóbralas con un clic o sin
  el pagador presente, y agenda suscripciones recurrentes.
</Card>
...
<Card title="Devoluciones de cobros" icon="rotate-left" href="/es/guias/devoluciones" horizontal>
  Devuelve total o parcialmente un cobro con tarjeta, anula un cargo del día y
  entiende cómo se aplica un contracargo.
</Card>
...
<AccordionGroup>
<Accordion title="¿Cómo sé que un payin se acreditó?">
...
<Accordion title="¿Qué tasa FX aplica a mi payin?">
...
<Accordion title="¿Los payins pueden caer en un saldo distinto de USDT?">
...
<Accordion title="¿Qué pasa cuando un cobro (QR, checkout) expira sin pago?">
Recibes `payin_expired` y el payin se cierra sin mover dinero. Crea un
cobro nuevo — nada se debitó ni acreditó.
</Accordion>
<Accordion title="El pagador transfirió un monto distinto al anunciado, ¿qué pasa?">
...
<Accordion title="Dos clientes anunciaron el mismo monto y ninguno puso la referencia, ¿a quién se le abona?">
...
<Accordion title="¿Ahora tengo que mandar payer_document?">
...
<Accordion title="Reintenté el POST del anuncio, ¿creé dos anuncios?">
...
<Accordion title="¿Cómo paga mi cliente de EE. UU. — wire doméstico o SWIFT internacional?">
...
<Accordion title="¿Por qué el QR bancario es solo texto para copiar y no algo que mi app bancaria escanea?">
