...
<AccordionGroup>
<Accordion title="¿Escanear un QR tiene costo?">
No — el scan es una lectura local gratuita. Solo se cobra cuando el confirm
crea el payout.
</Accordion>
<Accordion title="¿Puedo pagar el mismo QR dos veces?">
...
<Accordion title="¿Cómo reintento un confirm fallido sin riesgo?">
