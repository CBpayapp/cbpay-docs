...
<AccordionGroup>
<Accordion title="¿Qué pasa si la cuenta todavía no tiene screening AML?">
...
<Accordion title="¿Cómo se informa el PEP de una persona designada?">
...
<Accordion title="¿Qué es el colchón que veo reservado en compras BTC/GOLD/SILVER/PLATINUM?">
