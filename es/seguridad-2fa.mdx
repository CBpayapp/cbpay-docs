...
[Perfil y seguridad](/es/guias/perfil).
</Note>
...
<AccordionGroup>
  <Accordion title="¿El OTP afecta mis integraciones server-to-server?">
  ...
  <Accordion title="¿Puedo pedir el token una vez y usarlo en varias acciones?">
  ...
  <Accordion title="La acción falló después de consumir el token, ¿pago dos veces?">
