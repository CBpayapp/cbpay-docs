...
- **Recovery contract**: added the durable core idempotency status route and the org-ops reconciliation path for ambiguous company CLABE claims. Platform recovery is fail-closed with `deposit_account_not_recoverable`, `idempotency_conflict`, and a recovery lease fence.
