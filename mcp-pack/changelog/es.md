...
- **Contrato de recovery**: se agregaron la ruta durable de estado de idempotencia del core y la reconciliación org-ops para claims ambiguos de CLABE empresarial. El recovery es fail-closed con `deposit_account_not_recoverable`, `idempotency_conflict` y fence de lease.
