...
| `409 card_limit_reached` | La cuenta persona ya tiene una tarjeta viva o una solicitud de tarjeta abierta |
| `400 physical_temporarily_unavailable` | La emisión física nueva está pausada; las tarjetas físicas existentes siguen operativas |
