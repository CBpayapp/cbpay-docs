...
| `payin_corridor_unsupported` | El país/moneda/método no tiene un proveedor de payin activo — vuelve a leer `GET /v1/payins/methods` |
...
| 502 | `deposit_account_failed` | No se pudo aprovisionar la cuenta receptora; lee el listado antes de reintentar |
