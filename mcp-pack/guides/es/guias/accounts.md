...
-  Deposita crypto directo a tu wallet de cada red.
- **Fiat a Crypto** (`?tab=fiat`): elige un país y ve la ficha de **datos para
  transferir** de cada cuenta de ese país. Las fichas Fiat nunca muestran QR.
-  Deposita fiat a tus datos y se convierte a crypto en tu saldo.
...
-  Cuentas bancarias a tu nombre con saldo en moneda local fiat.

**Estas cuentas son solo tuyas: únicas, no compartidas.**

Cuando un icono representa una red, la página usa el icono de esa red: TRON
usa su marca roja y Ethereum su diamante azul. Los iconos de activos siguen
representando los activos.
...
flowchart LR
  ...
  open --> tabs["Pestañas Crypto / Fiat a Crypto / Banking"]
...
Selecciona **Crypto**, **Fiat a Crypto** o **Banking**, y luego la moneda, país,
...
| **Fiat a Crypto** | Elige **MX**, **BO** o **EU**. Las cuentas MX/BO muestran una ficha con titular, `bank_name` cuando viene informado, `merchant_nit` para BO cuando viene informado y CLABE o número de cuenta. EU muestra el vIBAN de fondeo (`purpose: funding_usdt`). La pestaña Fiat a Crypto **no tiene QR**. | La ficha completa, copiada con **Copiar todo**, o el IBAN de fondeo después de revisar su estado. |
...
- **Fiat a Crypto no tiene QR por diseño:** usa la ficha de datos para transferir y
