...
slug: es/guias/swaps
lang: es
source_url: https://docs.cbpayapp.com/es/guias/swaps
---
...
decimales (6 para USDT/USDC/GOLD/SILVER/PLATINUM, 8 para BTC).
...
[cartola](https://docs.cbpayapp.com/es/guias/cartola) el swap aparece como `swap_out` en la moneda
...
- **Tasa de ejecución del momento**: para BTC y GOLD se usa el precio de
  ...
  precio viejo).
- **Límites para monedas volátiles** (BTC/GOLD/SILVER/PLATINUM, compartidos con payouts y
  ...
  tiene límite.
- Requiere tu [verificación de identidad](https://docs.cbpayapp.com/es/guias/kyc) aprobada y el
...
|---|---|---|---|
| 400 | `invalid_asset` | Moneda fuera de USDT/USDC/BTC/GOLD/SILVER/PLATINUM | Revisa `from_asset`/`to_asset` |
...
pagados desde BTC/GOLD/SILVER/PLATINUM y compras con tarjeta desde BTC/GOLD/SILVER/PLATINUM — todos suman
