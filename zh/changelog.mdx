...
<Update label="2026年9月26日" description="v2.131 · 2 个版本">
...
<Update label="2026年9月25日" description="v2.129 · 1 version">
...
<Update label="2026年9月24日" description="v2.128 · 4 versions">
...
<Update label="2026年9月23日" description="v2.124 · 3 个版本">
...
<Update label="2026年9月22日" description="v2.121 · 3 versions">
...
<Update label="2026年9月21日" description="v2.118 · 2 个版本">
...
<Update label="2026年9月20日" description="v2.116 · 1 个版本">
...
<Update label="2026年9月19日" description="v2.115 · 6 个版本">
...
<Update label="2026年9月18日" description="v2.109 · 8 个版本">
...
<Update label="2026年9月17日" description="v2.101 · 8 个版本">
...
<Update label="2026年9月16日" description="v2.92 · 4 个版本">
...
<Update label="2026年9月15日" description="v2.88 · 3 个版本">
...
<Update label="2026年9月14日" description="v2.85 · 5 个版本">
...
<Update label="2026年9月13日" description="v2.80 · 3 个版本">
...
<Update label="2026年9月12日" description="v2.77 · 3 versions">
...
<Update label="2026年9月11日" description="v2.74 · 1 个版本">
...
<Update label="2026年9月10日" description="v2.73 · 1 个版本">
...
<Update label="2026年9月9日" description="v2.72 · 1 个版本">
...
<Update label="2026年9月6日" description="v2.71 · 3 个版本">
...
- **您的 `idempotency_key` 会随 webhook 返回**。您使用幂等键创建的资金操作，
  ...
  [webhooks](/zh/webhooks) 和 [幂等性](/zh/concepts/idempotency)。

</Update>

<Update label="2026年9月4日" description="v2.68">
...
- **委内瑞拉的拉取式收款（`c2p` / `debito_inmediato`）已不再提供**。
  ...
  （自 v2.66 起不变）。参见 [payins](/zh/guides/payins) 与
  [checkout](/zh/guides/checkout)。

</Update>

<Update label="2026年9月3日" description="v2.67 · 2 个版本">
...
- **以卡支付的收银台和 POS 收款现在遵循银行卡结算延迟**。当您的
  ...
  详见[费用——银行卡收款结算延迟](/zh/concepts/fees#银行卡收款结算延迟)。

### v2.66

**已变更**

- **委内瑞拉 `pago_movil` payout 现在要求 `beneficiary.name`**。通道要求受益人的名 + 第一姓氏（与证件一致）—— 单个词会被拒绝。[payout 指南](/zh/guides/payouts)和 API 参考示例现在将 `name` 列为必填字段的第一项。委内瑞拉 `bank_transfer` 此前已记录 `name`；此处无变更。

</Update>

<Update label="2026年9月2日" description="v2.65">
...
- **Webhook `wallet_signature_created` 和 `wallet_linked`。** 在创建证明和绑定外部钱包时发出。参考：[Webhooks](/zh/webhooks)。
- **每次服务端签名都会发送安全邮件。** 账户持有人会收到一封品牌化邮件，其中包含每次签名的钱包、链、用途和时间戳。

</Update>

<Update label="2026年8月20日" description="v2.63">

### v2.63

**修复**

- **`verifications_unavailable` 的提示不再声称已退还费用。** 身份验证返回 503 并不意味着退款：验证文档接口从不收费，自助入驻也不收取任何费用。该提示现在仅建议稍后重试。参考：[错误](/zh/errors) 与 [KYC 指南](/zh/guides/kyc)。

</Update>

<Update label="2026年8月19日" description="v2.62">

### v2.62

**变更**

- **当账单国家/地区要求时，托管卡支付页面现在强制填写账单州/省。** 对于捕获卡扣款时 ISO 3166-2 行政区为必填的国家（例如美国、加拿大、巴西），现在会向付款人显示必填的**州/省**字段，选项来自行政区目录；该值作为账单地址的 `administrative_area` 传输。无强制行政区的国家仍保持该字段可选。指南：[银行卡支付](/zh/guides/payins)。
- **已保存卡（MIT）扣款在发起前校验账单地址。** 保存时已带完整账单地址的卡照常工作。如果已保存的卡没有可用的账单地址，扣款将被拒绝并返回 `422 core_rejected`，消息会提示付款人通过 `save_card: true` 重新保存该卡 —— 不会发生资金变动。指南：[已保存的卡片与订阅](/zh/guides/stored-cards-subscriptions)。
...
<Update label="2026年8月17日" description="v2.61">

### v2.61

**新增**

- **账户 locale `en` / `es` / `zh`。** `GET /v1/me` 现在返回 `locale`。`PATCH /v1/me` 发送 `{ "locale": "en" | "es" | "zh" }` 即可持久化；空字符串存为英语；其他非空值返回 `400 invalid_locale`（`"locale must be en, es or zh"`）。新账户在创建时选择 locale（请求体，然后是 `Accept-Language`，然后是组织的 `default_locale`，最后是英语）。指南：[语言与 locale](/zh/guides/locale)。
...
<Update label="2026年8月12日" description="v2.60">
...
<Update label="2026年8月11日" description="v2.59">
...
- **美元银行通道付款：收款人可居住在任何国家**
  （[付款指南](/zh/guides/payouts)）：对于 `ach`、`wire` 和 `swift`
...
<Update label="2026年8月10日" description="v2.58 · 3 个版本">
...
- **配置结算延迟的银行卡收款会立即确认为 `credited`**
  （[费用](/zh/concepts/fees#银行卡收款结算延迟)）：当
...
<Update label="2026年8月9日" description="v2.55 · 6 个版本">
...
- **可配置的银行卡收款结算延迟**
  （[费用](/zh/concepts/fees#银行卡收款结算延迟)）：`payin_card`
...
- **按通道计收的银行费用**
  （[费用](/zh/concepts/fees#按通道计收的银行费用)）：新增五个交易型费用服务
...
- **Qscore 可验证公开印章**（[印章指南](/zh/guides/qscore-seal)）：
...
- **Qscore 授权链接（持有人授权）**（[授权链接指南](/zh/guides/qscore-consents)）：
...
- **Qscore 批量评分(组合评分)**([批量评分指南](/zh/guides/qscore-batch)):
...
<Update label="2026年8月8日" description="v2.49 · 9 个版本">

### v2.49

**新增**

- **Qscore —— 您自己的信用报告,免费**([Qscore 指南](/zh/guides/qscore)):已验证账户的
  ...
  **免费**(不收取费用),主体身份来自账户已验证的 `tax_id`(请求从不接受
  ...
  `invalid_tax_id`([错误](/zh/errors))。

### v2.48

**变更**

- **银行与开卡申请现在可被挂起审核**([银行指南](/zh/guides/banking)、[开卡指南](/zh/guides/cards)、[交易审核](/zh/guides/transaction-reviews)):如果您所在的组织启用了申请审核,`POST /v1/banking/customer`、`POST /v1/banking/third-parties` 和 `POST /v1/cards` 可能会返回 **`202 Accepted`**(`{"status":"in_review","kind":"...","review_id":"..."}`),而不是立即创建资源——在合规团队批准审核之前,不会发送任何内容进行处理。开户/发卡费用在申请被挂起时收取,若被拒绝将**自动退还**。使用相同 `idempotency_key` 的重试会返回同一审核(`idempotency_hit: true`),绝不会重复收费。通过 `txn_review_status_changed` webhook 或在[交易审核](/zh/guides/transaction-reviews)(类型 `banking_application` / `card_application`)中跟踪结果。

### v2.47

**新增**

- **Qscore —— 主体持续监控**([Qscore 指南](/zh/guides/qscore)):当你已持有某主体的
  ...
  (有意设计,防止探测主体是否存在)。新增错误码:`report_required`([错误](/zh/errors))。

### v2.46

**新增**

- **付款的银行参考号现已覆盖所有界面**([付款指南](/zh/guides/payouts)):每笔付款都会展示
...
- **Qscore — API 优先的信用局**([Qscore 指南](/zh/guides/qscore)):购买个人
...
- 新增错误码:`purpose_required`、`invalid_purpose`、`invalid_doc_id`、`invalid_subject_type`、
  `no_score`、`pdf_not_ready`([错误](/zh/errors))。
...
- **城市目录质量改进**([AML 目录指南](/zh/guides/aml)):
...
- **通过 API 获取跟踪链接**([跟踪指南](/zh/guides/tracking)):新增的认证端点
...
- **每笔交易的公开跟踪链接**（[跟踪指南](/zh/guides/tracking)）：每张回单（payout、payin、
...
<Update label="2026年8月7日" description="v2.40 · 4 个版本">

### v2.40

**新增**

- **银行目录查询**（[付款指南](/zh/guides/payouts)）：新增的
...
- **邮政编码查询**（[AML 指南](/zh/guides/aml)）：新增的
...
- **按国家查询城市目录**（[AML 指南](/zh/guides/aml)）：新增的
  ...
  在客户端按州/省筛选。
- **US/USD 充值现在发布两条存款通道**（[充值指南](/zh/guides/payins)）：
...
- **按审核期限自动拒绝**（[交易审核指南](/zh/guides/transaction-reviews)）—
...
- **新增 payin 走廊：美国（USD）预报银行转账（ACH / wire）**。账户通过
  ...
  请求/响应示例、状态表、错误和 FAQ）见 [Payins 指南](/zh/guides/payins)；
  `deposit_instructions` 区块和预览端点已在 API 参考中更新。

</Update>

<Update label="2026年8月6日" description="v2.36 · 3 个版本">
...
- **交易防火墙**：当您的组织启用交易防火墙时，资金操作（法币 payout、加密
  ...
  新指南：[交易审核](/zh/guides/transaction-reviews)。
...
- **新增出金通道：美国（USD）**，提供三种方式 —— `ach`（次日 ACH
  ...
  **USD 25.00**。向全新收款人发起的第一笔 payout 可能保持
  ...
  真实示例与 FAQ 见 [出金](/zh/guides/payouts)；API 参考中新增
...
- [MCP 服务器](/zh/mcp)页面现在提及面向**组织管理**文档的专用 MCP
  服务器（`mcp-admin.cbpayapp.com`，部署中），以便组织管理员了解
  org-admin API 也有对应的助手内容源——本公开服务器继续覆盖账户级 API。

</Update>

<Update label="2026年8月5日" description="v2.33 · 2 个版本">
...
<Update label="2026年8月4日" description="v2.31 · 4 个版本">
...
- **银行操作增强字段**：`GET /v1/banking/operations` 和
  ...
  （轻量 + 查询详情）。详见[银行业务](/zh/guides/banking)。
...
- **支付页面上经付款人验证的已保存卡片**：每个银行卡支付页面（`card`
  ...
  **验证码**，验证通过后才展示卡片 —— 卡片列表绝不在未验证的情况下
  ...
  输入卡号。详见
  [已保存卡片](/zh/guides/stored-cards-subscriptions#付款人在支付页面上发现自己的卡片)。
...
<Update label="2026年8月3日" description="v2.27 · 2 个版本">
...
- **停用和重新启用 webhook 订阅**：新增
  ...
  [webhooks 指南](/zh/webhooks#停用和重新启用订阅)。
...
<Update label="2026年8月2日" description="v2.25 · 3 个版本">

### v2.25

**变更**

- **补充管理端错误码文档**：在[错误目录](/zh/errors)中新增了
...
- **转账通知类 payin 的入金说明**（[payins 指南](/zh/guides/payins)）：
...
<Update label="2026年8月1日" description="v2.22 · 1 个版本">
...
- **活体检测现支持同一主体多个会话**
  ([身份验证](/zh/guides/kyc))：验证报告的 `liveness[]` 数组可为同一人携带多条
...
<Update label="2026年7月30日" description="v2.21 · 1 个版本">
...
- **验证报告封面可导航**
  ([身份验证](/zh/guides/kyc))：PDF 首页为**可点击**的索引卡片（图标、标题与
...
<Update label="2026年7月28日" description="v2.20 · 2 个版本">

### v2.20

**新增**

- **验证报告中的视觉证据**（[身份验证](/zh/guides/kyc)）：当提供商发布活体
...
- **完整的验证报告，不丢弃任何数据**（[身份验证](/zh/guides/kyc)）：KYC/KYB
...
<Update label="2026年7月27日" description="v2.18 · 3 个版本">

### v2.18

**修复**

- **金额始终为普通十进制**（[收款](/zh/guides/payins)）：收款的
...
- **可下载的 KYC/KYB 验证报告**（[身份验证](/zh/guides/kyc)）：每个 KYC/KYB
...
- **QR 收款现在始终自动入账**（[payins](/zh/guides/payins)）：已支付的 QR
...
<Update label="2026年7月26日" description="v2.15 · 1 个版本">

### v2.15

**修复**

- **预告转账现已遵循幂等性**（[payins](/zh/guides/payins)）：
...
<Update label="2026年7月25日" description="v2.14 · 6 个版本">

### v2.14

**新增**

- **预告转账的付款人识别**（[充值](/zh/guides/payins)）：
...
- **预告转账不再按金额匹配"最早的一笔"**：如果两条或以上待处理预告的
  ...
  **一个**候选时，纯金额匹配才继续生效。详见新增章节
  [预告转账的匹配规则](/zh/guides/payins)。

### v2.13

**新增**

- **事件流握手配额**（[错误](/zh/errors)）：连续过于频繁地打开
...
- **卡收款退款**（[指南](/zh/guides/refunds)）：`POST /v1/payins/{payinID}/refunds`
...
- **收款上的退款状态**：已退款的 payin 会返回 `refund_status`（`partial` 或
  ...
  （累计退还给持卡人的金额）。
- **`payin_refunded` webhook**（[webhooks](/zh/webhooks)）：每一笔退款、撤销
...
- **手续费与汇率价差不予退还**：退款时按已入账的毛额扣除，我们为处理该笔支付所收取
  ...
  充值。
- **新增错误码**（[错误](/zh/errors)）：`payin_not_refundable`、
...
- **公开服务状态页面重新设计**（[指南](/zh/service-status)）：
...
- **以美元结算的国际银行卡**（[指南](/zh/guides/payins)）：`POST /v1/payins`
  ...
  [后续收款与订阅](/zh/guides/stored-cards-subscriptions)。3-D Secure 在页面
...
<Update label="2026年7月24日" description="v2.08 · 6 个版本">

### v2.08

**新增**

- **实时服务状态**（[指南](/zh/service-status)）：`GET /v1/payouts/methods`
...
- **独立的产品指南**（从 payins/payouts 长文中拆分）：
  [Checkout 收款链接](/zh/guides/checkout)、
  [已保存卡片与订阅](/zh/guides/stored-cards-subscriptions) 和
  [QR 出金](/zh/guides/qr-payout)。原有章节保留标题并链接到新指南，
  历史锚点仍然有效。
- [集成流程](/zh/flows) 新增**端到端流程**：checkout、已保存卡片与订阅、
...
- [个人资料与安全](/zh/guides/profile) 与
  [安全与双因素认证（OTP）](/zh/security-2fa) 现已互相链接并明确分工：
...
- **测试环境贯穿全站**：每个产品指南现在都在开头展示测试与正式环境的基础
  URL（共享组件），[常见问题](/zh/faq)、[快速开始](/zh/quickstart)和
  [介绍](/zh/introduction)也正确描述了测试环境
...
<Update label="2026年7月23日" description="v2.02 · 6 个版本">
...
- **自动兑换为 `default_payin_asset` 现按真实价格执行，不收取兑换点差**
  （[资金模型](/zh/concepts/money-model)）：收款入账时已支付其手续费与
...
- **新错误码 `reserved_idempotency_key`（400）**：`POST /v1/swaps`
  （[错误](/zh/errors)）中，前缀为 `payin-convert:` 或 `checkout-swap:`
...
- **收款默认余额（`default_payin_asset`）**
  （[资金模型](/zh/concepts/money-model)）：选择收款最终入账到哪个
...
- **银行卡收款专属佣金（`payin_card`）**
  ([佣金](/zh/concepts/fees))：通过银行卡入账的收款（`method: card` 的
...
- **`GET /v1/banking/accounts/{bankAccountID}`**（[银行服务指南](/zh/guides/banking)）：
...
<Update label="2026年7月22日" description="v1.96 · 3 个版本">

### v1.96

**新增**

- **新通道：阿根廷** 🇦🇷（[出金指南](/zh/guides/payouts) · [入金指南](/zh/guides/payins)）：
...
- **随已保存卡片存档的账单信息**（[payins 指南](/zh/guides/stored-cards-subscriptions)）：付款人保存卡片时填写的账单信息（姓名、地址、城市、邮箱、电话）会与凭证一并保存。再次使用该卡支付时，安全页面自动应用这些信息 — 付款人无需重新输入 — 且只显示**脱敏摘要**（姓名、部分邮箱和城市），并提供"使用其他信息"链接以便修改。完整信息绝不下发到浏览器：由服务器在授权时应用。
...
- **结账页 — 银行卡一键支付**（[收款指南](/zh/guides/checkout)）：在公开页面选择银行卡继续时，现在直接跳转到安全支付页 — 移除了需要二次点击的中间按钮。点击已保存的卡即刻发起支付。
...
<Update label="2026年7月21日" description="v1.93 · 3 个版本">

### v1.93

**修复**

- **第三方的银行 webhook**（[webhooks](/zh/webhooks)、[银行指南](/zh/guides/banking)）：当你账户注册的**第三方**验证状态变化时，`banking_customer_status_changed` webhook 现在也会触发（此前只有自己档案的事件送达）。payload 新增 `customer_kind`（`self` | `third_party`），第三方还附 `third_party_id`（与 `GET /v1/banking/third-parties/{id}` 的 id 相同）。

### v1.92

**修复**

- **payin 历史中的 checkout 收款金额**（[payins 指南](/zh/guides/checkout)）：`GET /v1/payins` 和 `GET /v1/payins/{payin_id}` 现在在所有状态（包括待支付和已过期）都返回 checkout 和 QR POS 收款的计价 — `settlement_asset` + `asset_amount`（适用时还有 `conversion_status`）。此前金额只在入账后出现，待支付的行没有金额。此外，以加密货币或 CBPay 应用结算的收款即使没有 `fx_rate` 也会返回 `usdt_credited`。CSV/XLSX 导出新增 `settlement_asset` 和 `asset_amount` 列。

### v1.91

**新增**

- **订阅（计划性循环扣款）**（[payins 指南](/zh/guides/stored-cards-subscriptions)）：平台为已存卡的扣款执行排期。`POST /v1/subscriptions`（`interval` daily/weekly/monthly/yearly、可选 `start_at` 用于试用、必填 `idempotency_key`）在创建时扣款首个周期并自动触发其余周期。完整资源 `GET /v1/subscriptions`（+`/{id}`，过滤 status/stored_card_id/payer_reference）及生命周期 `POST .../pause` · `/resume` · `/cancel`。被拒时催收（每天重试 ×3 ⇒ `past_due`），恢复时不补扣，撤销卡片时自动取消。每次成功扣款像普通卡 payin 一样入账（`payin_credited` 带 `subscription_id`）。新增 webhook `subscription_status_changed`。

</Update>

<Update label="2026年7月20日" description="v1.90">

**新增**

- **已保存卡片与循环扣款**（[payins 指南](/zh/guides/stored-cards-subscriptions)）：`card` 方式现支持存储凭证（卡组织 COF 规范）。`POST /v1/payins` 接受 `save_card`（托管页面上的同意复选框）、`payer_reference`（你的客户 ID）和 `stored_card_id`（使用已保存的卡支付，免输卡号；3-D Secure 照常运行）。新资源 `GET /v1/stored-cards`（+`/{id}`、`DELETE` 撤销）以及付款人不在场的**商户发起扣款**：`POST /v1/stored-cards/{id}/charges`（`recurring` 用于订阅；必须提供 `idempotency_key` — 重试绝不重复扣款）。卡号从不存在于平台：仅展示数据（卡组织、末四位、有效期）。新增 webhook `card_stored` 和 `stored_card_revoked`；新增错误 `422 stored_card_revoked`（[错误](/zh/errors)）。

</Update>

<Update label="2026年7月18日" description="v1.89 · 2 个版本">
...
<Update label="2026年7月17日" description="v1.87 · 4 个版本">
...
<Update label="2026年7月16日" description="v1.83 · 10 个版本">
...
- **巴西 PIX 二维码出金（BR/BRL）**：两步流程
  ...
  **静态** PIX 二维码（含 "copia e cola" 代码）——传 `country: "BR"` 与
  ...
  [payouts 指南](/zh/guides/qr-payout)。
...
<Update label="2026年7月15日" description="v1.73 · 5 个版本">
...
<Update label="2026年7月14日" description="v1.68 · 7 个版本">
...
<Update label="2026年7月13日" description="v1.61 · 6 个版本">
...
<Update label="2026年7月12日" description="v1.55 · 9 个版本">
...
<Update label="2026年7月11日" description="v1.46 · 7 个版本">
...
<Update label="2026年7月10日" description="v1.39 · 7 个版本">
...
<Update label="2026年7月9日" description="v1.32 · 7 个版本">
...
<Update label="2026年7月8日" description="v1.25 · 8 个版本">
...
<Update label="2026年7月7日" description="v1.17 · 16 个版本">
...
<Update label="2026年7月6日" description="v1.1 · 2 个版本">
