...
详情：[付款](/zh/guides/payouts) · [QR 出金](/zh/guides/qr-payout)。
...
详情：[收款](/zh/guides/payins) · [Checkout](/zh/guides/checkout)。
...
详情：[Checkout](/zh/guides/checkout)。
...
详情：[已保存卡片与订阅](/zh/guides/stored-cards-subscriptions)。
...
资金不离开账户，因此无需 OTP。详情：[兑换](/zh/guides/swaps)。
